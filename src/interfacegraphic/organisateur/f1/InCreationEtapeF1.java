...
public class InCreationEtapeF1 extends JFrame {
	...
	public InCreationEtapeF1(EditionF1 ed, Course c) {

		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 378, 345);
		...
		btnConfirmer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ed.ajouterEtape(new EtapeF1(Integer.valueOf(textFieldNum.getText()),
						...
						Float.valueOf(textFieldH.getText()), txtVille.getText(), txtPays.getText()));
				dispose();
			}
		});

		btnConfirmer.setBounds(127, 236, 85, 21);
		contentPane.add(btnConfirmer);

		textFieldNum = new JTextField();
		textFieldNum.setBounds(116, 28, 96, 19);
		...
		txtS = new JTextField();
		txtS.setBounds(217, 70, 55, 19);
		contentPane.add(txtS);
		txtS.setColumns(10);

		JLabel lblVille = new JLabel("Ville : ");
		lblVille.setBounds(43, 126, 46, 13);
		contentPane.add(lblVille);

		JLabel lblPays = new JLabel("Pays : ");
		lblPays.setBounds(43, 168, 46, 13);
		contentPane.add(lblPays);

		txtVille = new JTextField();
		txtVille.setBounds(116, 123, 96, 19);
		contentPane.add(txtVille);
		txtVille.setColumns(10);

		txtPays = new JTextField();
		txtPays.setBounds(116, 165, 96, 19);
