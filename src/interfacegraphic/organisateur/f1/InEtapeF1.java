...
public class InEtapeF1 extends JFrame {
	 ...
	 * @param ed
	 */
	public InEtapeF1(EditionF1 ed, CourseF1 c) {
		...
		listEtape.addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent e) {
				if (listEtape.getSelectedIndex() != -1) {
					...
					afficherEtapeSelected(ed.getEtapeT(listEtape.getSelectedIndex()));
				} else {
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (listEtape.getSelectedIndex() != -1) {
					...
					ed.getEtapeT(listEtape.getSelectedIndex()).setTempsLimite(h, m, s);
					init(ed, c);
				}
		...
		lblLblv = new JLabel("");
		lblLblv.setBounds(45, 36, 107, 13);
		panelF1.add(lblLblv);
	...
	private void afficherEtapeSelected(EtapeF1 et) {
		...
		lblLblv.setText(et.getVille());
		lblLblp.setText(et.getPays());
	}
