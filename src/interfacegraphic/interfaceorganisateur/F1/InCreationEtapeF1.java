...
public class InCreationEtapeF1 extends JFrame {
	...
	public InCreationEtapeF1(Edition ed, Course c) {
		...
		btnConfirmer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ed.ajouterEtape(new EtapeF1(Integer.valueOf(textFieldNum.getText()),Integer.valueOf(textFieldH.getText()), Integer.valueOf(textFieldM.getText()), Float.valueOf(textFieldH.getText())));			
				dispose();
			}
		});
