...
public class InSpeciale extends JFrame {
	 ...
	 * @param ed 
	 */
	public InSpeciale(Etape etape,Edition ed, Course c) {
		EtapeRallye et = (EtapeRallye) etape;
		...
		// ajouter
				btnAjouter.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						InCreationSpeciale ics = new InCreationSpeciale(etape,ed,c);
						ics.setVisible(true);
					}
				});
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (listSpeciale.getSelectedIndex() != -1) {
					...
					et.getSpeciale(listSpeciale.getSelectedIndex()).enregistrerTemps(h, m, s);
					init(et,ed,c);
				}
	...
	private void init(EtapeRallye et,Edition e,Course c) {
		...
		// initialiser la liste des course			
				...
				for(Speciale s : et.getListeSpeciale()) {
